...
**During the course "Javascript fördjupning" at Medieinstitutet we were tasked with developing a Tic Tac Toe game using the Vue framework and TypeScript.**
...
- #### **Clona the repository from GitHub:**
    - git clone https://github.com/Medieinstitutet/vue-tictactoe-RebeckaGothlin
